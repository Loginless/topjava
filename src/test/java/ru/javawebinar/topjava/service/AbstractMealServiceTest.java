...
import static ru.javawebinar.UserTestData.ADMIN_ID;
import static ru.javawebinar.UserTestData.USER_ID;
...
public abstract class AbstractMealServiceTest extends AbstractServiceTest {
    ...
    public void testValidation() throws Exception {
        Assume.assumeTrue(!checkProfile("jdbc"));
...
//            System.out.println(">>>>>>"+profile);
        ...
        return result.contains(profileName);
    }
}